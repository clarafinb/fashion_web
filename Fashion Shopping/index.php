        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-1 col-md-1 col-1">
                    <a href="javacript:void(0)"><img src="images/logo.png" alt="logo"></a>
                </div>
                <div class="col-sm-6 col-md-6">
                    <div class="free-shipping">
                        <a href="javascript:void(0)"><img src="images/box.png" alt=""> Free 2-Days Shipping $35+</a>
                    </div>
                    <ul class="nav">
                        ...
                        <li class="nav-item"><a href="/limited-time-offer.html" class="light">LIMITED - TIME OFFER</a></li>
                    </ul>
                </div>
        ...
        <div class="row imagesGroup">
            <div class="imageContainer fade1" id="0">
                <div class="col-sm-7 col-md-7">
                    <a href=""><img src="images/Female11.jpg"></a>
                </div>
                <div class="col-sm-5 col-md-5">
                    ...
                    <button type="submit" class="btn btn btn-default btn-new-arrival">WOMEN</button>
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="slider-men">
                        ...
                        <div class="slider-man-sub-content">
                            <button type="submit" class="btn btn btn-default btn-new-arrival">MAN</button>
           ...
           <div class="imageContainer fade1" id="2">
            ...
            <div class="imageContainer fade1" id="3">
                <div class="col-sm-6 col-md-6" style="padding-top: 150px; padding-left: 50px;">
                    ...
                    <div class="btn-sport">
                        <button type="submit" class="btn btn btn-default btn-new-arrival">SHOP NOW</button>
                    </div>
                    
                </div>
                <div class="col-sm-6 col-md-6">
                    <a href=""><img src="images/Model22.jpg"></a>
                </div> 
            </div>
    ...
    <div class="container trending">
        ...
        <div class="row" style="padding: 0 10px;">
            <div class="col-sm-3 col-md-3">
                <a href="/"><img src="images/NT1.png" alt=""></a>
            </div>
            <div class="col-sm-3 col-md-3">
                <a href="/"><img src="images/NT2.png" alt=""></a>
            </div>
            <div class="col-sm-3 col-md-3">
                <a href="/"><img src="images/NT3.png" alt=""></a>
            </div>
            <div class="col-sm-3 col-md-3">
                <a href="/"><img src="images/NT4.png" alt=""></a>
            </div>
        </div>
    </div>
    <br />
    <div class="container">
        ...
        <div class="row text-center newOfferGroup">
            <div class="newOfferContainer fade1" id="10">
                <div class="col-sm-7 col-md-7">
                    <a href=""><img src="images/Model1.jpg"></a>
                </div>
                <div class="col-sm-5 col-md-5" style="padding-top: 50px; padding-right: 60px;">
                    ...
                    <button type="submit" class="btn btn-default btn-font">SHOP NOW</button>
            ...
            <div class="newOfferContainer fade1" id="11">
                ...
                <div class="col-sm-6 col-md-6" style="padding-top: 50px; padding-right: 60px;">
                    ...
                    <button type="submit" class="btn btn btn-default btn-font">SHOP NOW</button>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row padding-footer">
                ...
                <div class="col-sm-4 col-md-4">
                    ...
                    <form class="subscribe-form" action="/subscribe.html">
